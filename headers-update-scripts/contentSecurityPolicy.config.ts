...
const cspConfig = {
  ...
  'object-src': ["'none'"],
  'font-src': ["'self'"],
  'style-src-elem': ["'self'", "'unsafe-inline'", 'https://fonts.cdnfonts.com/css/source-sans-pro'],
  'style-src': ["'self'", "'unsafe-inline'", 'https://fonts.cdnfonts.com/css/source-sans-pro'],
