...
class KdvElementsService extends __BaseService {
   ...
   * @return OK
   */
  KdvElementsGetKdvsResponse(
    params: KdvElementsService.KdvElementsGetKdvsParams
  ): __Observable<__StrictHttpResponse<KdvElementsResponseDto>> {
    let __params = this.newParams();
    const __headers = new HttpHeaders();
    const __body: any = null;
    if (params.sortOrder != null) {
      __params = __params.set('sortOrder', params.sortOrder.toString());
    }
  ...
  KdvElementsGetKdvs(
    params: KdvElementsService.KdvElementsGetKdvsParams
  ): __Observable<KdvElementsResponseDto> {
