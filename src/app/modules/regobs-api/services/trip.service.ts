...
class TripService extends __BaseService {
  ...
  TripPutResponse(
    ...
    let __body: any = null;
    __body = trip;
    const req = new HttpRequest<any>('PUT', this.rootUrl + '/Trip', __body, {
      headers: __headers,
      params: __params,
      responseType: 'json'
    });
  ...
  TripPut(trip: FinishTripDto): __Observable<null> {
    return this.TripPutResponse(trip).pipe(__map((_r) => _r.body as null));
  }
  ...
  TripPostResponse(
    ...
    let __body: any = null;
    __body = trip;
    const req = new HttpRequest<any>('POST', this.rootUrl + '/Trip', __body, {
      headers: __headers,
      params: __params,
      responseType: 'json'
    });
  ...
  TripPost(trip: CreateTripDto): __Observable<{}> {
    return this.TripPostResponse(trip).pipe(__map((_r) => _r.body as {}));
  }
}
