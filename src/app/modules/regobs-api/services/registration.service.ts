...
class RegistrationService extends __BaseService {
  ...
  static readonly RegistrationPlotPreviewPngPath =
    '/Registration/PlotPreviewPng';
  ...
  RegistrationGetResponse(
    params: RegistrationService.RegistrationGetParams
  ): __Observable<__StrictHttpResponse<RegistrationViewModel>> {
  ...
  RegistrationGet(
    params: RegistrationService.RegistrationGetParams
  ): __Observable<RegistrationViewModel> {
   ...
   * @return OK
   */
  RegistrationPlotPreviewPngResponse(
    params: RegistrationService.RegistrationPlotPreviewPngParams
  ): __Observable<__StrictHttpResponse<{}>> {
    ...
    if (params.langKey != null) {
      __params = __params.set('langKey', params.langKey.toString());
    }
    const req = new HttpRequest<any>(
      'POST',
   ...
   * @return OK
   */
  RegistrationInsertResponse(
    registration: CreateRegistrationRequestDto
  ): __Observable<__StrictHttpResponse<CreateRegistrationResponseDto>> {
    const __params = this.newParams();
    const __headers = new HttpHeaders();
    let __body: any = null;
    __body = registration;
  ...
  RegistrationInsert(
    registration: CreateRegistrationRequestDto
  ): __Observable<CreateRegistrationResponseDto> {
